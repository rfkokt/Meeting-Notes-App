...
import { Home, Mic, BookOpen, Settings, Sun, Moon, Plus, Menu, X } from "lucide-react"
...
export function TopNavbar({ currentPage, onPageChange, onNewMeeting }: TopNavbarProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-gray-100">MeetingAI</span>
          </div>
